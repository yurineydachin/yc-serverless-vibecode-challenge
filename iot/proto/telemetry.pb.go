...
func (x *Telemetry) GetPayload() *TelemetryPayload {
	if x != nil {
		return x.Payload
	}
	return nil
...
const file_telemetry_proto_rawDesc = "" +
	"\n" +
	"\x0ftelemetry.proto\x12\x11iot.backend.proto\x1a\x17telemetry_payload.proto\"J\n" +
	"\tTelemetry\x12=\n" +
	"\apayload\x18\x01 \x01(\v2#.iot.backend.proto.TelemetryPayloadR\apayloadb\x06proto3"
...
var file_telemetry_proto_goTypes = []any{
	(*Telemetry)(nil),        // 0: iot.backend.proto.Telemetry
	(*TelemetryPayload)(nil), // 1: iot.backend.proto.TelemetryPayload
}
var file_telemetry_proto_depIdxs = []int32{
	1, // 0: iot.backend.proto.Telemetry.payload:type_name -> iot.backend.proto.TelemetryPayload
...
func file_telemetry_proto_init() {
	...
	file_telemetry_payload_proto_init()
	type x struct{}
