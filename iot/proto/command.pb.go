...
// Top level schema for any command
type Command struct {
	...
	Payload       *CommandPayload        `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"`                // Application-layer data
...
func (x *Command) GetChainId() string {
	if x != nil {
		return x.ChainId
	}
	return ""
...
const file_command_proto_rawDesc = "" +
	"\n" +
	"\rcommand.proto\x12\x11iot.backend.proto\x1a\x15command_payload.proto\"a\n" +
	"\aCommand\x12\x19\n" +
	"\bchain_id\x18\x01 \x01(\tR\achainId\x12;\n" +
	"\apayload\x18\x02 \x01(\v2!.iot.backend.proto.CommandPayloadR\apayloadb\x06proto3"
...
var file_command_proto_goTypes = []any{
	(*Command)(nil),        // 0: iot.backend.proto.Command
	(*CommandPayload)(nil), // 1: iot.backend.proto.CommandPayload
}
var file_command_proto_depIdxs = []int32{
	1, // 0: iot.backend.proto.Command.payload:type_name -> iot.backend.proto.CommandPayload
...
func file_command_proto_init() {
	...
	file_command_payload_proto_init()
	type x struct{}
